...
class CommitteesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create committee" do
    assert_difference('Committee.count') do
      post committees_url, params: { committee: { name: @committee.name, resoures: @committee.resoures } }
    end
  ...
  test "should update committee" do
    patch committee_url(@committee), params: { committee: { name: @committee.name, resoures: @committee.resoures } }
