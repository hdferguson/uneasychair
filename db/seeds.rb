...
Conference.create(name: 'First Conference')
Conference.create(name: 'Second Conference')
Conference.create(name: 'Third Conference')

Paper.delete_all
Paper.create(title: 'How do I shot Web', author: 'CB', 
    attachment: open('app/assets/files/learn-rails-1.pdf'), conference_id: 1)
Paper.create(title: 'How to earn money', author: 'Heather Ferguson', 
    attachment: open('app/assets/files/learn-rails-2.pdf'), conference_id: 2)
Paper.create(title: 'How to make a Website', author: 'Dustin Geohagan', 
    attachment: open('app/assets/files/agile-web-development-with-rails-5_p1_0.pdf'), conference_id: 2)
Paper.create(title: 'Derp', author: 'Testing', 
    attachment: open('app/assets/files/rails-bootstrap.pdf'), conference_id: 3)


Review.delete_all
Review.create(score: 10, comments: 'Here we are!', paper_id: 1)
Review.create(score: 9, comments: 'Born to be Kings!', paper_id: 1)
Review.create(score: 8, comments: 'We are the Princes of the Universe!', paper_id: 1)
Review.create(score: 8, comments: 'Here We belong!', paper_id: 1)
Review.create(score: 4, comments: 'Fighting to survive in a war with the darkest powers!', paper_id: 1)
